...
(
  ...
  '<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px"><div style="background:#204ce5;padding:20px;border-radius:12px 12px 0 0;text-align:center"><h1 style="color:#fff;margin:0;font-size:24px">Crédit Unique</h1></div><div style="background:#fff;padding:30px;border:1px solid #EBEBEB;border-top:none;border-radius:0 0 12px 12px"><p>Bonjour <strong>{{prenom}}</strong>,</p><p>Votre dossier <strong>{{titre_dossier}}</strong> est en attente de documents. Voici les pièces manquantes :</p>{{liste_documents}}<p style="text-align:center;margin:30px 0"><a href="{{lien_dossier}}" style="background:#204ce5;color:#fff;padding:14px 28px;border-radius:8px;text-decoration:none;font-weight:bold;display:inline-block">Compléter mon dossier</a></p><hr style="border:none;border-top:1px solid #EBEBEB;margin:20px 0"><p style="color:#585e6a;font-size:12px">Crédit Unique — Gestion des dossiers</p></div></div>',
